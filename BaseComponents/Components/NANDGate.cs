...
{
    class NANDGate : Component, Properties.IDrawBorder
    {
        #region JointLocs
        ...
        {
            Logics = new Logics.NANDGateLogics();
            Graphics = new Graphics.NANDGateGraphics();
        ...
        {
            Components.Graphics.NANDGateGraphics.LoadContentStatic();
        }
