...
{
    class ORGate : Component, Properties.IDrawBorder
    {
        #region JointLocs
        ...
        {
            Logics = new Logics.ORGateLogics();
            Graphics = new Graphics.ORGateGraphics();
        ...
        {
            Components.Graphics.ORGateGraphics.LoadContentStatic();
        }
