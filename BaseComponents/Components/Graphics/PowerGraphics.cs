...
namespace MicroWorld.Components.Graphics
{
    class PowerGraphics : GraphicalComponent
    {
        ...
        {
            texture0cw = ComponentsManager.LoadTexture("Components/Power/Power0cw");
            texture90cw = ComponentsManager.LoadTexture("Components/Power/Power90cw");
            texture180cw = ComponentsManager.LoadTexture("Components/Power/Power180cw");
            texture270cw = ComponentsManager.LoadTexture("Components/Power/Power270cw");
        }

        public override string GetIconName()
        {
            return "Components/Icons/Power";
        }
        ...
        {
            return "Components/Power Source.edf";
        }
