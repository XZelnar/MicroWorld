...
{
    class XORGateGraphics : GraphicalComponent
    {
        ...
        {
            texture0cw = ComponentsManager.LoadTexture("Components/XORGate/XORGate0cw");
            texture90cw = ComponentsManager.LoadTexture("Components/XORGate/XORGate90cw");
            texture180cw = ComponentsManager.LoadTexture("Components/XORGate/XORGate180cw");
            texture270cw = ComponentsManager.LoadTexture("Components/XORGate/XORGate270cw");

            textureConnection1_0cw = ComponentsManager.LoadTexture("Components/XORGate/XORGateConnection1_0cw");
            textureConnection1_90cw = ComponentsManager.LoadTexture("Components/XORGate/XORGateConnection1_90cw");
            textureConnection1_180cw = ComponentsManager.LoadTexture("Components/XORGate/XORGateConnection1_180cw");
            textureConnection1_270cw = ComponentsManager.LoadTexture("Components/XORGate/XORGateConnection1_270cw");

            textureConnection2_0cw = ComponentsManager.LoadTexture("Components/XORGate/XORGateConnection2_0cw");
            textureConnection2_90cw = ComponentsManager.LoadTexture("Components/XORGate/XORGateConnection2_90cw");
            textureConnection2_180cw = ComponentsManager.LoadTexture("Components/XORGate/XORGateConnection2_180cw");
            textureConnection2_270cw = ComponentsManager.LoadTexture("Components/XORGate/XORGateConnection2_270cw");

            textureConnection3_0cw = ComponentsManager.LoadTexture("Components/XORGate/XORGateConnection3_0cw");
            textureConnection3_90cw = ComponentsManager.LoadTexture("Components/XORGate/XORGateConnection3_90cw");
            textureConnection3_180cw = ComponentsManager.LoadTexture("Components/XORGate/XORGateConnection3_180cw");
            textureConnection3_270cw = ComponentsManager.LoadTexture("Components/XORGate/XORGateConnection3_270cw");
        }

        public override string GetIconName()
        {
            return "Components/Icons/XORGate";
        }
        ...
        {
            return "Components/XOR Gate.edf";
        }
        ...
        public override void Draw(MicroWorld.Graphics.Renderer renderer)
        {
            ...
            if (!CanDraw()) return;
            Components.XORGate p = (Components.XORGate)parent;
            Components.Logics.XORGateLogics l = (Components.Logics.XORGateLogics)parent.Logics;
