...
{
    class Switch : Component, Properties.IDrawBorder
    {
        #region JointLocs
        ...
        public Wire W;
        private bool connected = false, startConnected = false;
        ...
        {
            Components.Graphics.SwitchGraphics.LoadContentStatic();
        }
