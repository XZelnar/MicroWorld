...
{
    public class LampProperties : GeneralProperties
    {
        public Label title;
        ...
        public override void Update()
        {
            ...
            brightness.text = ((int)((AssociatedComponent.Logics as Logics.LampLogics).Brightness * 100)).ToString() + " %";
        ...
        {
            var w = (AssociatedComponent as Lamp);
            ...
            color.background = (w.Graphics as Graphics.LampGraphics).LampColor;
            color.disabledColor = color.background;
            color.mouseOverColor = color.background;
            color.pressedColor = color.background;
        }
        ...
        public override void Save()
        {
            ...
            if (AssociatedComponent != null)
            {
                if (Double.TryParse(luminosity.Text, out t))
                {
                    ...
                    (AssociatedComponent as Lamp).Luminosity = (float)t;
                }

                (AssociatedComponent.Graphics as Graphics.LampGraphics).LampColor = color.background;
            }
        }
    }
}
