...
{
    class ANDGate : Component, Properties.IDrawBorder
    {
        #region JointLocs
        ...
        {
            Logics = new Logics.ANDGateLogics();
            Graphics = new Graphics.ANDGateGraphics();
        ...
        {
            Components.Graphics.ANDGateGraphics.LoadContentStatic();
        }
