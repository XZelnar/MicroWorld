...
{
    class Transistor : Component, Properties.IDrawBorder
    {
        #region JointLocs
        ...
        public Transistor(float x, float y)
        {
            constructor();
        ...
        public override void InitAddChildComponents()
        {
            ...
            Joints[4].CanBeGround = true;
            Joints[4].IsGround = false;
            Joints[4].CanProvidePower = false;
            Joints[4].IsProvidingPower = false;

            Joints[5].Graphics.Visible = false;
            Joints[5].CanProvidePower = true;
            Joints[5].IsProvidingPower = true;
            ...
            W3 = new Wire(Joints[2], Joints[5]);
            W3.Direction = Wire.WireDirection.J2ToJ1;
            W3.Resistance = 5;
        ...
        {
            Components.Graphics.TransistorGraphics.LoadContentStatic();
        }
