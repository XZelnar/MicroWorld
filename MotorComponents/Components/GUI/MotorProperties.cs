...
{
    public class MotorProperties : GeneralProperties
    {
        public Label title;
        ...
        public override void Initialize()
        {
            ...
            resistance = new TextBox(105, 80, (int)size.X - 110, 20);
        ...
        {
            var w = (AssociatedComponent as Motor);
        ...
        public override void Save()
        {
            ...
            if (AssociatedComponent != null)
            {
                if (Double.TryParse(resistance.Text, out t))
                {
                    ...
                    (AssociatedComponent as Motor).Resistance = (float)t;
                }
            }
        }
    }
